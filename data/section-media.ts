...
export const sectionMediaPlacements: SectionMediaPlacement[] = [
  ...
  {
    key: "story.dating-anniversary",
    sectionId: "story",
    label: "Story · Dating anniversary",
    description: "Photograph for the dating anniversary milestone.",
    accepts: ["image"],
    allowMultiple: false,
    defaultCategory: "relationship_memory",
    storyMomentId: "dating-anniversary",
  },
  {
    key: "story.milestone-placeholder",
    sectionId: "story",
    label: "Story · Open chapter",
    description: "Photograph for the open milestone chapter.",
    accepts: ["image"],
    allowMultiple: false,
    defaultCategory: "relationship_memory",
    storyMomentId: "milestone-placeholder",
  },
  {
    key: "story.proposal",
    sectionId: "story",
